"""Phase 158 (P2): 'status effects'. Recompile
...
for nm in ("SK_Hero", "Enemy_Briarbound_01"):
...
time.sleep(1.4)
print("shot:", json.dumps(studio_capture_screenshot(name="fv_status_effects"))[:120])
print("STATUS-FX DONE ok=%s wired=%s missing=%s" % (
