...
// Auto-generated by UnityTools autopilot. Collectible pickup (trigger). On pickup it scores
// IMMEDIATELY (decoupled SendMessage) then plays a short scale-up "pop" before destroying
// itself -- a bit of juice on the collect moment so a grab feels good. Deterministic (only
// Time, no RNG); the `collected` guard fires the score exactly once even during the pop.
